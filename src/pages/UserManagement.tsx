    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white/70 dark:bg-zinc-900/60 backdrop-blur-md p-5 md:p-6 rounded-2xl border border-zinc-200/60 dark:border-zinc-800/40 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400 dark:text-zinc-500 font-semibold mt-0.5">Manage staff crew details, credentials, and access credentials</p>
          </div>
        </div>
        <Button 
          onClick={() => { 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card className="border border-zinc-200/60 dark:border-zinc-800/40 bg-white/70 dark:bg-zinc-900/60 backdrop-blur-md rounded-2xl shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-xs font-bold text-zinc-450 dark:text-zinc-550 uppercase tracking-wider">System Administrators</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-[10px] text-zinc-450 dark:text-zinc-550 mt-1 font-semibold italic">Complete configuration control</p>
          </CardContent>
        </Card>

        <Card className="border border-zinc-200/60 dark:border-zinc-800/40 bg-white/70 dark:bg-zinc-900/60 backdrop-blur-md rounded-2xl shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-xs font-bold text-zinc-450 dark:text-zinc-550 uppercase tracking-wider">Operations Managers</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-[10px] text-zinc-455 dark:text-zinc-550 mt-1 font-semibold italic">Access to inventories & sales reports</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-zinc-900 dark:bg-zinc-950 text-white rounded-2xl shadow-sm border border-zinc-850 relative overflow-hidden">
          ...
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0 relative z-10">
            <CardTitle className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Service Crew / Staff</CardTitle>
          ...
          <CardContent className="relative z-10">
            ...
            <p className="text-[10px] text-zinc-400 mt-1 font-semibold italic">Take billing orders & operate kitchen</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border border-zinc-200/60 dark:border-zinc-800/40 bg-white/70 dark:bg-zinc-900/60 backdrop-blur-md rounded-2xl shadow-sm overflow-hidden">
        <CardHeader className="px-5 py-4 border-b border-zinc-150 dark:border-zinc-800/50 flex flex-col sm:flex-row sm:items-center justify-between gap-3 space-y-0">
          ...
          <Badge variant="outline" className="w-fit rounded-lg border-zinc-200 dark:border-zinc-800 text-[10px] font-bold uppercase tracking-wider px-3 py-1 bg-zinc-50/50 dark:bg-zinc-955/20 text-zinc-500">
            Active Directory
          </Badge>
        </CardHeader>
            ...
            <Table>
              <TableHeader className="bg-zinc-50/50 dark:bg-zinc-955/20 border-b border-zinc-155 dark:border-zinc-800/50">
                <TableRow className="border-zinc-155 dark:border-zinc-800/50 hover:bg-transparent">
                  <TableHead className="py-4 pl-6 font-bold text-zinc-500 dark:text-zinc-400 uppercase text-[10px] tracking-wider">Team Member</TableHead>
                  <TableHead className="font-bold text-zinc-500 dark:text-zinc-400 uppercase text-[10px] tracking-wider text-center">Permission Role</TableHead>
                  <TableHead className="font-bold text-zinc-500 dark:text-zinc-400 uppercase text-[10px] tracking-wider text-center hidden md:table-cell">Joined On</TableHead>
                    ...
                    <TableCell className="py-4 pl-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col min-w-0">
                          ...
                          <span className="text-[9px] font-bold text-emerald-600 dark:text-emerald-500 uppercase tracking-widest mt-0.5">Online / Active</span>
                        </div>
                      </div>
                    </TableCell>
        ...
        <DialogContent className="max-w-md p-0 overflow-hidden border border-zinc-200/60 dark:border-zinc-800/40 rounded-2xl bg-white dark:bg-zinc-900 shadow-xl w-full">
          ...
          <div className="bg-zinc-900 dark:bg-zinc-950 p-6 text-white relative overflow-hidden border-b border-zinc-800">
             ...
             <DialogHeader className="p-0 relative z-10 space-y-1">
                ...
                <DialogTitle className="text-xl font-bold tracking-tight">Onboard Team Member</DialogTitle>
                <DialogDescription className="text-zinc-400 text-xs font-semibold">
                  Provision login credentials and set role-based dashboard permissions
                </DialogDescription>
              </DialogHeader>
          </div>
          ...
          <div className="p-6 space-y-5 bg-white dark:bg-zinc-900">
            <div className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-zinc-450 dark:text-zinc-550 uppercase tracking-wider ml-0.5">Username / Full Name</label>
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-zinc-450 dark:text-zinc-555 uppercase tracking-wider ml-0.5">Access Password</label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-zinc-455 dark:text-zinc-555 uppercase tracking-wider ml-0.5">System Permission Role</label>
            ...
            <div className="flex gap-2.5 pt-2">
              ...
              >
                {saving ? <Loader2 className="animate-spin size-4" /> : 'Create User'}
              </Button>
            </div>
          </div>
        </DialogContent>
